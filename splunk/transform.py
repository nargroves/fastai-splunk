...
__all__ = ['add_datepart', 'cont_cat_split', 'Categorify', 'FillMissing', 'FillStrategy', 'Normalize', 'SplunkProc',
...
@dataclass
class SplunkProc():
    "A processor for splunk dataframes."
    cat_names:StrList
    cont_names:StrList
